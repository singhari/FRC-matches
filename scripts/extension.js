...
async function openSite(){
  ...
  if(!bad){
    var event = await chrome.runtime.sendMessage({ url: "https://ftc-api.firstinspires.org/v2.0/2025/events?eventCode="+code.value.trim() })
    var tm = await chrome.runtime.sendMessage({ url: "https://ftc-api.firstinspires.org/v2.0/2025/teams?teamNumber="+team.value.trim() })
